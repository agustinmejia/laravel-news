    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <div class="col-md-8" data-aos="fade-up">
                <h3 class="category-title">Categoría: {{ $slug }}</h3>
                ...
                <div>
                    <div class="post-meta"><span class="date">{{ $slug }}</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                    <h3><a href="single-post.html">What is the son of Football Coach John Gruden, Deuce Gruden doing Now?</a></h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas, nobis error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                    <div class="d-flex align-items-center author">
                    <div class="photo"><img src="{{ asset('assets/img/person-2.jpg') }}" alt="" class="img-fluid"></div>
                    <div class="name">
                ...
                <div class="d-md-flex post-entry-2 half">
                <a href="single-post.html" class="me-4 thumbnail">
                    <img src="{{ asset('assets/img/post-landscape-4.jpg') }}" alt="" class="img-fluid">
                </a>
                <div>
                    <div class="post-meta"><span class="date">{{ $slug }}</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                    <h3><a href="single-post.html">What is the son of Football Coach John Gruden, Deuce Gruden doing Now?</a></h3>
            ...
            <div class="col-md-4">
                ...
                <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-latest-tab" data-bs-toggle="pill" data-bs-target="#pills-latest" type="button" role="tab" aria-controls="pills-latest" aria-selected="false">Últimos</button>
                    </li>
                </ul>
                ...
                <ul class="aside-links list-unstyled">
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Negocios</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Cultura</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Deportes</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Cocina</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Política</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Farandula</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Tecnología</a></li>
                    <li><a href="{{ url('category/deportes') }}"><i class="bi bi-chevron-right"></i> Viajes</a></li>
                </ul>
                </div><!-- End Categories -->
