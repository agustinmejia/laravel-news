                    ...
                    <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            ...
                            <table align="right">
                                <tr>
                                    <td>
                                        <a href="https://wa.me/{{ setting('social.whatsapp') ?? '59175199157' }}?text={{ url('post/'.$post->slug) }}" target="_blank" class="btn btn-success btn-sm" style="height: 28px;"><i class="bi-whatsapp"></i> WhastApp</a>
                                    </td>
                                    <td>
