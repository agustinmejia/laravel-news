...
@section('seo')
    <title>Acerca de nosotros | {{ setting('site.title') }}</title>
    ...
    <meta property="og:title"         content="Acerca de nosotros | {{ setting('site.title') }}" />
                ...
                <!-- Left -->
                    <div class="flex-shrink max-w-full w-full lg:w-2/3  overflow-hidden">
                        ...
                        <h2 class="text-gray-800 text-3xl font-bold">
                            <span class="inline-block h-5 border-l-3 border-red-600 mr-2"></span> Acerca de nosotros
                        </h2>
                        </div>
                        <div class="flex flex-row flex-wrap -mx-3">
                            <div class="max-w-full w-full px-4">
                                ...
                                <div class="leading-relaxed pb-4">
                                    {!! setting('acerca-de.long-description') !!}
                                </div>
                            </div>
                        </div>
                    </div>
