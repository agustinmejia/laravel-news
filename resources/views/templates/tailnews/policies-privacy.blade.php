...
@section('seo')
    <title>Políticas de privacidad | {{ setting('site.title') }}</title>
    ...
    <meta property="og:title"         content="Políticas de privacidad | {{ setting('site.title') }}" />
                    ...
                    <div class="flex-shrink max-w-full w-full lg:w-2/3  overflow-hidden">
                        <div class="w-full py-3 mb-3">
                            <h2 class="text-gray-800 text-3xl font-bold">
                                <span class="inline-block h-5 border-l-3 border-red-600 mr-2"></span> Políticas de privacidad
                            </h2>
                        </div>
                        <div class="flex flex-row flex-wrap -mx-3">
                            <div class="max-w-full w-full px-4 pb-5">
                                ...
                                <div class="leading-relaxed pb-5" style="text-align: justify">
                                    <p>{{ 'Fecha de entrada en vigencia: '.setting('politicas-de-privacidad.date') }} </p>
                                    <br>
                                    {!! setting('politicas-de-privacidad.policies-privacy') !!}
                                </div>
                            </div>
                        </div>
                    </div>
