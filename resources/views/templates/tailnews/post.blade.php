...
@section('seo')
    ...
    <meta property="og:image"         content="{{ $post->banner ? asset('storage/'.str_replace('.', '-banner.', $post->banner)) : asset('templates/tailnews/img/default.png') }}" />
@endsection
                        ...
                        <div class="flex flex-row flex-wrap -mx-3">
                            <div class="max-w-full w-full px-4">
                                ...
                                <figure class="text-center mb-6">
                                    <img class="max-w-full h-auto" src="{{ $post->banner ? asset('storage/'.$post->banner) : asset('templates/tailnews/img/default.png') }}" alt="Image description">
                                ...
                                <figure class="lg:float-left text-center lg:text-left ml-0 lg:-ml-4 mr-7 mb-7">
                                    <img class="max-w-full h-auto mx-auto" src="{{ asset('templates/tailnews/img/dummy/post2.jpg') }}" alt="Image description">
                                ...
                                <figure class="lg:float-right text-center lg:text-right mr-0 lg:-mr-4 ml-7 mb-7">
                                    <img class="max-w-full h-auto mx-auto" src="{{ asset('templates/tailnews/img/dummy/post3.jpg') }}" alt="Image description">
                                ...
                                {{-- <div class="flex flex-wrap flex-row -mx-4 justify-center py-4">
                                    <div class="flex-shrink max-w-full px-4 w-1/3 sm:w-1/4 md:w-1/6">
                                        <a href="#"><img class="rounded-full border max-w-full h-auto dark:border-gray-700" src="{{ asset('templates/tailnews/img/dummy/avatar.jpg') }}" alt="author"></a>
                                    </div>
                                ...
                                {{-- <div id="comments" class="pt-16">
                                    ...
                                    <ol class="mb-4">
                                        ...
                                        <div class="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                                            <footer>
                                            <img class="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4" src="{{ asset('templates/tailnews/img/avatar2.jpg') }}" alt="avatar">
                                            <div>
                                        ...
                                        <ul class="ml-12 md:ml-24">
                                            ...
                                            <div class="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                                                <footer>
                                                <img class="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4" src="{{ asset('templates/tailnews/img/avatar.jpg') }}" alt="avatar">
                                                <div>
