...
<html lang="es">
  <head>
    ...
    <!-- Development css -->
    <link rel="stylesheet" href="{{ asset('templates/tailnews/css/style.css') }}">
  ...
  <body class="text-gray-700 pt-9 sm:pt-10">
    ...
    <header class="fixed top-0 left-0 right-0 z-50">
      <nav class="" style="background-color: #005d48">
          <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
            <div class="flex justify-between">
              <div class="mx-w-10 text-2xl font-bold capitalize text-white flex items-center">
                @if (setting('site.navbar_logo'))
                  <img src="{{ Voyager::image(Voyager::setting('site.navbar_logo')) }}" alt="{{ setting('site.title') }}" width="200px">  
                @else
              ...
              <div class="flex flex-row">
                <!-- nav menu -->
                <ul class="navbar hidden lg:flex lg:flex-row text-gray-400 text-sm items-center font-bold pt-1">
                  <li class="active relative border-l border-gray-800 hover:bg-gray-900">
                    <a class="block py-3 px-6 border-b-2 border-transparent" href="{{ url('') }}">Inicio</a>
                  </li>
                  <li class="relative border-l border-gray-800 hover:bg-gray-900">
                    <a class="block py-3 px-6 border-b-2 border-transparent" href="{{ url('about') }}">Acerca de</a>
                  </li>
                  <li class="dropdown relative border-l border-gray-800 hover:bg-gray-900">
                    <a class="block py-3 px-6 border-b-2 border-transparent" href="#">Categorías</a>
                    ...
                    <ul class="dropdown-menu font-normal absolute left-0 right-auto top-full z-50 border-b-0 text-left bg-white text-gray-700 border border-gray-100" style="min-width: 12rem;">
                      ...
                      <li class="relative hover:bg-gray-50"><a class="block py-2 px-6 border-b border-gray-100" href="{{ url('category/'.$item->slug) }}">{{ $item->name }}</a></li>
                      @endforeach
      ...
      <nav id="mobile-nav" class="side-menu flex flex-col right-0 w-64 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40">
        <div class="mb-auto">
          ...
          <nav class="relative flex flex-wrap">
            <div class="text-center py-4 w-full font-bold border-b border-gray-100"><a href="{{ url('') }}">{{ setting('site.title') }}</a></div>
            <ul id="side-menu" class="w-full float-none flex flex-col">
              <li class="relative">
                <a href="{{ url('') }}" class="block py-2 px-5 border-b border-gray-100 hover:bg-gray-50">Inicio</a>
              </li>
              <li class="relative">
                <a href="{{ url('about') }}" class="block py-2 px-5 border-b border-gray-100 hover:bg-gray-50">Acerca de</a>
              </li>
        ...
        <div class="py-4 px-6 text-sm mt-6 text-center">
          <p>Copyright <a href="{{ env('APP_DEVELOPER_URL', 'https://desarrollocreativo.dev') }}" target="_blank"><b>{{ env('APP_DEVELOPER_NAME', 'DesarrolloCreativo') }} {{ date('Y') }}</b></a> <br> Todos los derechos reservados</p>
        </div>
      </nav>
    </div><!-- End Mobile menu -->
          ...
          <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
            <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
              <div class="flex items-center mb-2">
                <span class="text-3xl leading-normal mb-2 font-bold text-gray-100 mt-2">{{ setting('site.title') }}</span>
              ...
              <ul class="space-x-3 mt-6 mb-6 Lg:mb-0">
                ...
                @if (setting('social.facebook'))
                  <li class="inline-block">
                    <a target="_blank" class="hover:text-gray-100" rel="noopener noreferrer" href="{{ setting('social.facebook') }}" title="Facebook">
                ...
                @if (setting('social.twitter'))
                  <li class="inline-block">
                    <a target="_blank" class="hover:text-gray-100" rel="noopener noreferrer" href="{{ setting('social.twitter') }}" title="Twitter">
                ...
                @if (setting('social.youtube'))
                  <li class="inline-block">
                    <a target="_blank" class="hover:text-gray-100" rel="noopener noreferrer" href="{{ setting('social.youtube') }}" title="Youtube">
                ...
                @if (setting('social.instagram'))
                  <li class="inline-block">
                    <a target="_blank" class="hover:text-gray-100" rel="noopener noreferrer" href="{{ setting('social.instagram') }}" title="Instagram">
            ...
            <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
              <div class="flex flex-wrap flex-row">
                <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                  <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Enlaces</h4>
                  <ul>
                    <li class="py-1 hover:text-white"><a href="{{ url('') }}">Inicio</a></li>
                    <li class="py-1 hover:text-white"><a href="{{ url('about') }}">Acerca de</a></li>
                ...
                <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                  <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Categorias</h4>
                  <ul>
                    @foreach (App\Models\Category::orderBy('order')->get() as $item)
                    <li class="py-1 hover:text-white"><a href="{{ url('category/'.$item->slug) }}">{{ Str::ucfirst($item->name) }}</a></li>    
                    @endforeach
                  </ul>
                </div>
                ...
                <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                  ...
                  <ul>
                    <li class="py-1 hover:text-white hover:text-white"><a href="{{ url('policies-privacy') }}">Políticas de privacidad</a></li>
                    <li class="py-1 hover:text-white"><a href="{{ url('terms-use') }}">Terminos de uso</a></li>
        ...
        <div class="py-4 border-t border-gray-200 border-opacity-10">
          <div class="row">
            <div class="col-12 col-md text-center">
              <p class="d-block my-3">Copyright <a href="{{ env('APP_DEVELOPER_URL', 'https://desarrollocreativo.dev') }}" target="_blank"><b>{{ env('APP_DEVELOPER_NAME', 'DesarrolloCreativo') }} {{ date('Y') }}</b></a> <br> Todos los derechos reservados</p>
            </div>
          </div>
        </div>
    ...
    <!--Vendor js-->
    <script src="{{ asset('templates/tailnews/vendors/hc-sticky/dist/hc-sticky.js') }}"></script>
    <script src="{{ asset('templates/tailnews/vendors/glightbox/dist/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('templates/tailnews/vendors/@splidejs/splide/dist/js/splide.min.js') }}"></script>
    <script src="{{ asset('templates/tailnews/vendors/@splidejs/splide-extension-video/dist/js/splide-extension-video.min.js') }}"></script>
    
    <!-- Start development js -->
    <script src="{{ asset('templates/tailnews/js/theme.js') }}"></script>
    <!-- End development js -->
