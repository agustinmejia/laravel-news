      ...
      <nav class="bg-black">
          <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
            <div class="flex justify-between">
              <div class="mx-w-10 text-2xl font-bold capitalize text-white flex items-center">{{ setting('site.title') }}</div>
      ...
      <nav id="mobile-nav" class="side-menu flex flex-col right-0 w-64 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40">
        <div class="mb-auto">
          ...
          <nav class="relative flex flex-wrap">
            <div class="text-center py-4 w-full font-bold border-b border-gray-100">{{ setting('site.title') }}</div>
            <ul id="side-menu" class="w-full float-none flex flex-col">
              <li class="relative">
                <a href="#" class="block py-2 px-5 border-b border-gray-100 hover:bg-gray-50">Inicio</a>
              </li>
        ...
        <div class="py-4 border-t border-gray-200 border-opacity-10">
          <div class="row">
            <div class="col-12 col-md text-center">
              <p class="d-block my-3">Copyright <a href="{{ env('APP_DEVELOPER_URL', 'https://desarrollocreativo.dev') }}" target="_blank"><b>{{ env('APP_DEVELOPER_NAME', 'DesarrolloCreativo') }} {{ date('Y') }}</b></a> - Todos los derechos reservados</p>
            </div>
          </div>
        </div>
